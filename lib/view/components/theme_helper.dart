...
class ThemeHelper{
  ...
  InputDecoration textInputDecoration([String lableText="", String hintText = ""]){
    return InputDecoration(
      ...
      focusedBorder: OutlineInputBorder(borderRadius: BorderRadius.circular(10.0), borderSide: BorderSide(color: Colors.blueAccent)),
  ...
  BoxDecoration buttonBoxDecoration(BuildContext context, [String color1 = "", String color2 = ""]) {
    ...
    return BoxDecoration(
      boxShadow: [
        BoxShadow(color: Colors.blueAccent, offset: Offset(0, 4), blurRadius: 5.0)
      ],
